...
> ⚠️ Пакет `mlflow` исключён из базовых `requirements*.txt`, поскольку версии
> ≥1.1.0 уязвимы (CVE-2024-37052…37060). Устанавливайте MLflow только в
> контролируемой среде, вручную обновляя его после выхода исправления. В
> `requirements-ml.txt` добавлен пин `mlflow>=2.17.0,<3` для удобной установки
> при необходимости.
