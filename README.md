...
> ⚠️ Пакет `mlflow` исключён из стандартных `requirements*.txt`, поскольку
> версии ≥1.1.0 уязвимы (CVE-2024-37052…37060). Устанавливайте MLflow только в
> контролируемой среде, вручную обновляя его после выхода исправления.
